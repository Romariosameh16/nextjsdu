						...
						<div className="row">
							<div className="col-lg-4">
								<div className="pe-8 mt-10">
									...
									<span className="fs-5 fw-medium" data-aos="fade-zoom-in" data-aos-delay={300}>Own a share in high-growth Dubai properties for as little as 1,000 AED. Enjoy fast returns from luxury villas to downtown apartments—no brokers, no hassle. 🔥</span>
