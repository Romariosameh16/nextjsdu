							...
							<div className="col-lg-6 col-md-12 mb-lg-0 mb-5">
								<div className="pe-2">
									<Link href="#" className="d-flex align-items-center bg-linear-1 d-inline-flex rounded-pill px-2 py-1">
										...
										<span className="fs-7 fw-medium text-primary mx-2">Properties funds</span>
									...
									<h3 className="ds-3 mt-4 mb-5" data-aos="fade-zoom-in" data-aos-delay={0}>Flip Dubai Real Estate. Invest Smart, Earn Fast.</h3>
									<p className="pe-10 mb-5" data-aos="fade-zoom-in" data-aos-delay={200}>Own a share in high-growth Dubai properties for as little as 1,000 AED. Enjoy fast returns from luxury villas to downtown apartments—no brokers, no hassle.</p>
						...
						<div className="row text-center position-relative z-1">
							<div className="col">
								<div className="border-linear-1 rounded-pill d-inline-block mb-2" data-aos="zoom-in" data-aos-delay={100}>
									<div className="text-primary bg-white px-4 py-2 rounded-pill fw-medium position-relative z-2">🚀 Properties funds</div>
								</div>
