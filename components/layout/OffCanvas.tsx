		...
		<>
			...
			<div className={`offCanvas__info ${isOffCanvas ? 'active' : ''}`}>
				...
				<div className="offCanvas__logo mb-30">
					<Link href="/"><img src="/assets/imgs/logo/logo (5).png" alt="Logo" /></Link>
				</div>
				<div className="offCanvas__side-info mb-30">
					...
					<div className="contact-list mb-30">
						...
						<p><Link href="/mailto:contact@Dubai & Flip.com">contact@Dubai & Flip.com</Link></p>
						<p><Link href="/mailto:sale@Dubai & Flip.com ">sale@Dubai & Flip.com </Link></p>
					</div>
					<div className="contact-list mb-30">
						<h4>Help  support</h4>
						<p>Email <Link href="/mailto:support@Dubai & Flip.com">support@Dubai & Flip.com</Link> For help with a current product or service or refer to FAQs and developer tools.</p>
					</div>
				</div>
