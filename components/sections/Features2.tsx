					...
					<div className="container">
						<div className="row align-items-center">
							<div className="col-lg-4 col-md-6 mb-lg-0 mb-8 position-relative z-1">
								...
								<h2 className="text-white mt-3 mb-4 fw-medium hover-up">Built for Smart  <span className="fw-bold">Property Flipping</span>.</h2>
									...
									<li>
										<Link href="#" className="phase-item d-flex align-items-center mb-3">
											<svg xmlns="http://www.w3.org/2000/svg" width={23} height={24} viewBox="0 0 23 24" fill="none">
												...
												<path d="M14.5013 8.64754L10.2188 12.93L7.99875 10.7119C7.51688 10.23 6.735 10.23 6.25313 10.7119C5.77125 11.1938 5.77125 11.9757 6.25313 12.4575L9.36751 15.5719C9.83626 16.0407 10.5975 16.0407 11.0663 15.5719L16.245 10.3932C16.7269 9.91129 16.7269 9.12941 16.245 8.64754C15.7631 8.16566 14.9831 8.16566 14.5013 8.64754Z" fill="#DDBF5F" />
											</svg>
											<p className="text-white mb-0 ms-3">Low Minimums</p>
										</Link>
									</li>
									<li>
										<Link href="#" className="phase-item d-flex align-items-center mb-3">
											...
											<p className="text-white mb-0 ms-3">Instant Diversification</p>
										</Link>
									</li>
									<li>
										<Link href="#" className="phase-item d-flex align-items-center mb-3">
											...
											<p className="text-white mb-0 ms-3">Property Insurance</p>
										</Link>
									</li>
									<li>
										<Link href="#" className="phase-item d-flex align-items-center mb-3">
											...
											<p className="text-white mb-0 ms-3">Exit Strategy Flexibility</p>
										</Link>
									</li>
								</ul>
							</div>
							<div className="col-lg-4 col-md-6 mb-lg-0 mb-8">
								<div className="position-relative d-inline-block z-2  hover-up">
									<img className="rounded-3 border border-3 border-white" src="/assets/imgs/features-2/infinia (4).png" alt="infinia" />
									<div className="position-absolute bottom-0 start-0 end-0 mb-3 mx-3 backdrop-filter rounded-3 text-start p-3">
										...
										<h6 className="mt-3">
										Co-invest in large-scale  <br />
										developments										</h6>
										<p className="fs-7 text-700">Earn monthly income from fully managed, high-demand rentals in prime districts like Dubai Marina and Downtown.</p>
									</div>
								</div>
							</div>
							<div className="col-lg-4 mb-lg-0 mb-8">
								<div className="px-lg-8">
									...
									<div data-aos="fade-zoom-in" data-aos-delay={100}>
										<h5 className="text-white mt-3 mb-3">Investor Community Access</h5>
										<p className="text-white border-bottom pb-3">Network with flippers, share strategies, and co-invest in larger projects.</p>
									</div>
									<div data-aos="fade-zoom-in" data-aos-delay={4200}>
										<h5 className="text-white mt-8 mb-3">Flexible Hold Periods</h5>
										<p className="text-white">Flip in 6 months or hold for 3 years—align with your financial goals.</p>
									</div>
								</div>
							</div>
						</div>
